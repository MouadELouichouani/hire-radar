                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        Are you sure you want to remove <strong>{user.full_name}</strong> from your connections?
                                        They will no longer be able to message you directly across some channels.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
